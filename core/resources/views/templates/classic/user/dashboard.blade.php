...
@section('content')
                    ...
                    <div class="card card-border-shadow-primary">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($total_posts) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($current_month_posts) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-warning">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($total_scans) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($current_month_scans) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-primary">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($total_users) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ format_number_count($current_month_users) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-warning">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ price_symbol_format($total_earnings) }}</h3>
                            </div>
                    ...
                    <div class="card card-border-shadow-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2 pb-1">
                                ...
                                <center><br><h3 class="ms-1 mb-0">{{ price_symbol_format($current_month_earnings) }}</h3>
                            </div>
                ...
                <div class="card card-border-shadow-primary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($total_posts) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Total Restaurants') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($current_month_posts) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Current Month Restaurants') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($total_scans) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Total Scans') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-info">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($current_month_scans) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Current Month Scans') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-primary">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($total_users) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Total Users') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ format_number_count($current_month_users) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Current Month Users') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ price_symbol_format($total_earnings) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Total Earnings') }}</p>
                    </div>
                </div>
                ...
                <div class="card card-border-shadow-info">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2 pb-1">
                            ...
                            <center><br>
                                <h3 class="ms-1 mb-0">{{ price_symbol_format($current_month_earnings) }}</h3>
                        </div>
                        <p class="mb-0 fs-6">{{ ___('Current Month Earnings') }}</p>
                    </div>
                </div>
        ...
        <div class="fun-facts-container">
            <div class="fun-fact" data-fun-fact-color="#36bd78">
                <div class="fun-fact-text">
                    ...
                    <h3>{{ count(request()->user()->posts) }}</h3>
                </div>
    ...
    <script src="https://jepa.test/assets/global/js/jquery.min.js"></script>
    <script src="https://jepa.test/assets/global/js/jquery-ui.min.js"></script>
    <script src="https://jepa.test/assets/admin/js/popper.min.js"></script>
    <script src="https://jepa.test/assets/admin/js/bootstrap.js"></script>
    <script src="https://jepa.test/assets/admin/js/tippy.all.min.js"></script>
    <script src="https://jepa.test/assets/admin/js/jquery.dataTables.min.js"></script>
    <script src="https://jepa.test/assets/admin/js/jquery-slidePanel.min.js"></script>
    <script src="https://jepa.test/assets/admin/js/sidePanel.js"></script>
    <script src="https://jepa.test/assets/admin/js/select2.full.min.js"></script>
    <script src="https://jepa.test/assets/global/js/jquery.form.js"></script>

    <script src="https://jepa.test/assets/admin/js/clipboard.min.js"></script>

    <script src="https://jepa.test/assets/admin/js/helpers.js"></script>
    <script src="https://jepa.test/assets/admin/plugins/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="https://jepa.test/assets/admin/js/menu.js"></script>
    <script src="https://jepa.test/assets/admin/js/main.js"></script>
    <script src="https://jepa.test/assets/admin/js/chart.min.js"></script>
    <script>
        const CURRENCY_CODE = "Rp";
    ...
    <script src="https://jepa.test/assets/admin/js/admin-ajax.js"></script>
    <script src="https://jepa.test/assets/admin/js/script.js"></script>
    <script src="https://jepa.test/assets/admin/js/quicklara.js"></script>
